-- =====================================================
--  SoftLife Growth Tracker — Database Schema
--  NOTE: db.php auto-creates all tables on first run.
--  This file is a manual reference / backup only.
-- =====================================================

CREATE DATABASE IF NOT EXISTS `softlife_db`
